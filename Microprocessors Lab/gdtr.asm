...
OUTPUT
mescoe@mescoe-virtual-machine:~$ nasm -f elf64 dpmi.asm
mescoe@mescoe-virtual-machine:~$ ld -o dpmi dpmi.o
mescoe@mescoe-virtual-machine:~$ ./dpmi
Processor is in Protected Mode
GDT Contents are::7F604000:007F
LDT Contents are::0000
IDT Contents are::81DD6000:0FFF
Task Register Contents are::0040
Machine Status Word::8005FFFF
mescoe@mescoe-virtual-machine:
